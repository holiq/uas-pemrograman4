...
<body>
    <script src="<?= base_url('js/initTheme.js') ?>" crossorigin="anonymous" async defer></script>
    <?php
    if (session()->get('username')):
    ?>
    <header>
        <nav id="sidebar" class="active sidebar-desktop">
            <div class="sidebar-wrapper active ps ps--active-y">
                <div class="sidebar-header position-relative">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="logo">
                            <a href="<?= route_to('Dashboard::index') ?>">UASepat</a>
                        </div>
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        <li class="sidebar-item">
                            <a href="<?= route_to('Dashboard::index') ?>" class='sidebar-link'>
                        ...
                        <li class="sidebar-item">
                            <a href="<?= route_to('Jadwal::index') ?>" class='sidebar-link'>
    ...
    <script src="<?= base_url('js/dark.js') ?>" crossorigin="anonymous" async defer></script>
    <script src="<?= base_url('js/perfect-scrollbar.min.js') ?>" crossorigin="anonymous" async defer></script>
    <script src="<?= base_url('js/app.js') ?>" crossorigin="anonymous" async defer></script>
    <script>
